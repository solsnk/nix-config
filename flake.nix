{
  ...
  in {
    ...
    nixosConfigurations = {
      ...
      # used for most things named 'otacon'.
      otacon = lib.nixosSystem {
        modules = [
          ./hosts/nixos/otacon/configuration.nix
        ];
        specialArgs = {
      ...
      # workstation, named 'quiet'.
      quiet = lib.nixosSystem {
        modules = [
          ./hosts/nixos/quiet/configuration.nix
        ];
        specialArgs = {
          inherit inputs outputs;
        };
      ...
      # used for testing, named 'raiden'.
      raiden = lib.nixosSystem {
        modules = [
